...
outreg2 using "..\output\Table_3-Panel_A.xml", replace excel ctitle(TONE) addtext(Year-quarter FE, YES, Firm FE, YES, Industry clustered SE, YES) dec(3) tdec(2) drop(i.cquarter) stats(coef tstat) adjr2
// regress TONE RET NEG RET_NEG $fin_controls $abt_controls
// outreg2 using "..\output\Table_3-Panel_A.xml", append excel ctitle(TONE) addtext(Year-quarter FE, NO, Firm FE, NO, Industry clustered SE, NO) dec(3) tdec(2) stats(coef tstat) adjr2
areg TONE i.cquarter RET NEG RET_NEG $fin_controls $abt_controls_8k, absorb(gvkey) cluster(SIC)
...
areg NW i.cquarter RET NEG RET_NEG $fin_controls $abt_controls_8k, absorb(gvkey) cluster(SIC)
outreg2 using "..\output\Table_3-Panel_A.xml", append excel ctitle(NW) addtext(Year-quarter FE, YES, Firm FE, YES, Industry clustered SE, YES) dec(3) tdec(2) drop(i.cquarter) stats(coef tstat) adjr2
...
// areg TONE_GI i.cquarter RET NEG RET_NEG $fin_controls $abt_controls_8k, absorb(gvkey) cluster(SIC)
// outreg2 using "..\output\Table_3-Panel_A.xml", append excel ctitle(TONE_GI) addtext(Year-quarter FE, YES, Firm FE, YES, Industry clustered SE, YES) dec(3) tdec(2) drop(i.cquarter) stats(coef tstat) adjr2
//
...
// areg TONE_HE i.cquarter RET NEG RET_NEG $fin_controls $abt_controls_8k, absorb(gvkey) cluster(SIC)
// outreg2 using "..\output\Table_3-Panel_A.xml", append excel ctitle(TONE_HE) addtext(Year-quarter FE, YES, Firm FE, YES, Industry clustered SE, YES) dec(3) tdec(2) drop(i.cquarter) stats(coef tstat) adjr2
// ******************************************************* GI and Henry dictionaries *****************************************
//
...
// // outreg2 using "..\output\Table_3-Panel_A.xml", append excel ctitle(TLAG) addtext(Year-quarter FE, NO, Firm FE, NO, Industry clustered SE, NO) dec(3) tdec(2) stats(coef tstat) adjr2
// areg TLAG i.cquarter RET NEG RET_NEG $fin_controls $abt_controls_8k, absorb(gvkey) cluster(SIC)
// outreg2 using "..\output\Table_3-Panel_A.xml", append excel ctitle(TLAG) addtext(Year-quarter FE, YES, Firm FE, YES, Industry clustered SE, YES) dec(3) tdec(2) drop(i.cquarter) stats(coef tstat) adjr2
...
outreg2 using "..\output\Table_4-Panel_A.xml", replace excel ctitle(TLAG) addtext(Year-month FE, YES, Firm FE, YES, Industry clustered SE, YES) dec(3) tdec(2) drop(i.cmonth) stats(coef tstat) adjr2
...
// outreg2 using "..\output\Table_4-Panel_A_2items.xml", replace excel ctitle(TLAG) addtext(Year-month FE, YES, Firm FE, YES, Industry clustered SE, YES) dec(3) tdec(2) drop(i.cmonth) stats(coef tstat) adjr2
// areg TLAG i.cmonth DRET BN DRET_BN $fin_controls $abt_controls_8k if nitem <= 2, absorb(cik) cluster(SIC)
...
// areg TONE i.cmonth DRET BN DRET_BN $fin_controls $abt_controls_8k if nitem <= 2, absorb(cik) cluster(SIC)
// outreg2 using "..\output\Table_4-Panel_A_2items.xml", append excel ctitle(TONE) addtext(Year-month FE, YES, Firm FE, YES, Industry clustered SE, YES) dec(3) tdec(2) drop(i.cmonth) stats(coef tstat) adjr2
//
...
// areg NW i.cmonth DRET BN DRET_BN $fin_controls $abt_controls_8k if nitem <= 2, absorb(cik) cluster(SIC)
// outreg2 using "..\output\Table_4-Panel_A_2items.xml", append excel ctitle(NW) addtext(Year-month FE, YES, Firm FE, YES, Industry clustered SE, YES) dec(3) tdec(2) drop(i.cmonth) stats(coef tstat) adjr2
//
// areg N8K i.cmonth DRET BN DRET_BN if nitem <= 2, absorb(cik) cluster(SIC)
// outreg2 using "..\output\Table_4-Panel_A_2items.xml", append excel ctitle(N8K) addtext(Year-month FE, YES, Firm FE, YES, Industry clustered SE, YES) dec(3) tdec(2) drop(i.cmonth) stats(coef tstat) adjr2
// areg N8K i.cmonth DRET BN DRET_BN $fin_controls $abt_controls_8k if nitem <= 2, absorb(cik) cluster(SIC)
// outreg2 using "..\output\Table_4-Panel_A_2items.xml", append excel ctitle(N8K) addtext(Year-month FE, YES, Firm FE, YES, Industry clustered SE, YES) dec(3) tdec(2) drop(i.cmonth) stats(coef tstat) adjr2
//
// areg NITEM i.cmonth DRET BN DRET_BN if nitem <= 2, absorb(cik) cluster(SIC)
// outreg2 using "..\output\Table_4-Panel_A_2items.xml", append excel ctitle(NITEM) addtext(Year-month FE, YES, Firm FE, YES, Industry clustered SE, YES) dec(3) tdec(2) drop(i.cmonth) stats(coef tstat) adjr2
// areg NITEM i.cmonth DRET BN DRET_BN $fin_controls $abt_controls_8k if nitem <= 2, absorb(cik) cluster(SIC)
// outreg2 using "..\output\Table_4-Panel_A_2items.xml", append excel ctitle(NITEM) addtext(Year-month FE, YES, Firm FE, YES, Industry clustered SE, YES) dec(3) tdec(2) drop(i.cmonth) stats(coef tstat) adjr2
//
// areg NEXHIBIT i.cmonth DRET BN DRET_BN if nitem <= 2, absorb(cik) cluster(SIC)
// outreg2 using "..\output\Table_4-Panel_A_2items.xml", append excel ctitle(NEXHIBIT) addtext(Year-month FE, YES, Firm FE, YES, Industry clustered SE, YES) dec(3) tdec(2) drop(i.cmonth) stats(coef tstat) adjr2
// areg NEXHIBIT i.cmonth DRET BN DRET_BN $fin_controls $abt_controls_8k if nitem <= 2, absorb(cik) cluster(SIC)
// outreg2 using "..\output\Table_4-Panel_A_2items.xml", append excel ctitle(NEXHIBIT) addtext(Year-month FE, YES, Firm FE, YES, Industry clustered SE, YES) dec(3) tdec(2) drop(i.cmonth) stats(coef tstat) adjr2
//
// areg NGRAPH i.cmonth DRET BN DRET_BN if nitem <= 2, absorb(cik) cluster(SIC)
// outreg2 using "..\output\Table_4-Panel_A_2items.xml", append excel ctitle(NGRAPH) addtext(Year-month FE, YES, Firm FE, YES, Industry clustered SE, YES) dec(3) tdec(2) drop(i.cmonth) stats(coef tstat) adjr2
// areg NGRAPH i.cmonth DRET BN DRET_BN $fin_controls $abt_controls_8k if nitem <= 2, absorb(cik) cluster(SIC)
// outreg2 using "..\output\Table_4-Panel_A_2items.xml", append excel ctitle(NGRAPH) addtext(Year-month FE, YES, Firm FE, YES, Industry clustered SE, YES) dec(3) tdec(2) drop(i.cmonth) stats(coef tstat) adjr2
...
// areg TLAG i.cmonth DRET BN DRET_BN, absorb(cik) cluster(SIC)
// outreg2 using "..\output\OAT_1.xml", replace excel ctitle(TLAG) addtext(Year-month FE, YES, Firm FE, YES, Industry clustered SE, YES) dec(3) tdec(2) drop(i.cmonth) stats(coef tstat) adjr2
// areg TLAG i.cmonth DRET BN DRET_BN $fin_controls $abt_controls_8k, absorb(cik) cluster(SIC)
