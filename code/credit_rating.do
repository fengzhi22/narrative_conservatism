...
replace date_comp = substr(date_comp,1,7)
gen date_ym = date(date_comp, "YM")
format date_ym %td
...
areg BTM i.fyearq LT_growth SalesGrowth tnic3hhi inv_CSI inv_spidx CFO rating STD_RET high_inf AOCI, absorb(SIC)
predict ME, xbd
...
reghdfe NW RET NEG RET_NEG if UCONS_HIGH == 1, a(gvkey i.cquarter) cluster(SIC)
...
reghdfe NW RET NEG RET_NEG $fin_controls $abt_controls if UCONS_HIGH == 1, a(gvkey i.cquarter) cluster(SIC)
...
reghdfe NW RET NEG RET_NEG if UCONS_HIGH == 2, a(gvkey i.cquarter) cluster(SIC)
...
reghdfe NW RET NEG RET_NEG $fin_controls $abt_controls if UCONS_HIGH == 2, a(gvkey i.cquarter) cluster(SIC)
outreg2 using "..\output\Table_12.xml", append excel ctitle(NW_HIGH) addtext(Year-quarter FE, YES, Firm FE, YES, Industry clustered SE, YES) dec(3) tdec(2) stats(coef tstat) adjr2

reghdfe TONE RET NEG RET_NEG if UCONS_HIGH == 1, a(gvkey i.cquarter) cluster(SIC)
...
reghdfe TONE RET NEG RET_NEG $fin_controls $abt_controls if UCONS_HIGH == 1, a(gvkey i.cquarter) cluster(SIC)
outreg2 using "..\output\Table_12.xml", append excel ctitle(TONE_LOW) addtext(Year-quarter FE, YES, Firm FE, YES, Industry clustered SE, YES) dec(3) tdec(2) stats(coef tstat) adjr2
reghdfe TONE RET NEG RET_NEG if UCONS_HIGH == 2, a(gvkey i.cquarter) cluster(SIC)
...
reghdfe TONE RET NEG RET_NEG $fin_controls $abt_controls if UCONS_HIGH == 2, a(gvkey i.cquarter) cluster(SIC)
outreg2 using "..\output\Table_12.xml", append excel ctitle(TONE_HIGH) addtext(Year-quarter FE, YES, Firm FE, YES, Industry clustered SE, YES) dec(3) tdec(2) stats(coef tstat) adjr2

reghdfe TLAG RET NEG RET_NEG if UCONS_HIGH == 1, a(gvkey i.cquarter) cluster(SIC)
...
reghdfe TLAG RET NEG RET_NEG $fin_controls $abt_controls if UCONS_HIGH == 1, a(gvkey i.cquarter) cluster(SIC)
outreg2 using "..\output\Table_12.xml", append excel ctitle(TLAG_LOW) addtext(Year-quarter FE, YES, Firm FE, YES, Industry clustered SE, YES) dec(3) tdec(2) stats(coef tstat) adjr2
reghdfe TLAG RET NEG RET_NEG if UCONS_HIGH == 2, a(gvkey i.cquarter) cluster(SIC)
...
reghdfe TLAG RET NEG RET_NEG $fin_controls $abt_controls if UCONS_HIGH == 2, a(gvkey i.cquarter) cluster(SIC)
outreg2 using "..\output\Table_12.xml", append excel ctitle(TLAG_HIGH) addtext(Year-quarter FE, YES, Firm FE, YES, Industry clustered SE, YES) dec(3) tdec(2) stats(coef tstat) adjr2
