...
\institute[EAA-VARS] % Your institution as it will appear on the bottom of every slide, may be shorth and to save space
...
%------------------------------------------------
\begin{frame}[noframenumbering]
\frametitle{Reported 8-K data in EDGAR by firm}
\begin{figure}[h]
	\centering
	\includegraphics[width=0.8\linewidth]{tab9}
	\label{8kdata}
